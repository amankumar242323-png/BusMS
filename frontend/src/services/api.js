...
export const addBus = (data) => api.post("/api/buses", data);
...
export const addRoute = (data) => api.post("/api/routes", data);
...
export const getAllSchedules = () => api.get("/api/schedules/admin/all");
